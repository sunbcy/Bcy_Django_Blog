...
class Article(models.Model):
    ...
    author = models.CharField(max_length=10, verbose_name='作者',default='Bcy',blank=True,null=True)
    desc = models.CharField(max_length=50, verbose_name='文章描述')
    """
    https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/lJLjEtbs2NFwynQ.jpg 黑客帝国封面
    https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/pexels-anna-nekrashevich-face.jpg macbook&书桌
    """
    cover = models.URLField(max_length=200, default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/pexels-anna-nekrashevich-face.jpg', verbose_name='文章封面')
...
class Link(models.Model):
    ...
    avatar = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/5a94e8dd6a694f646072c33755806288.jpg',verbose_name='头像')
...
class Social(models.Model):
    ...
    # social_url = models.CharField(max_length=255,verbose_name='社交链接')#
...
class Site(models.Model):
    """站点配置"""
    site_name = models.CharField(default='Bcy',max_length=30,verbose_name='网站名字')
    keywords = models.CharField(default='关键字测试',max_length=50, verbose_name='网站关键词')
    logo = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/quanyecha.jpg',max_length=100, verbose_name='网站logo')
    ...
    bg_cover = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/pexels-katja-592077.jpg',max_length=100,verbose_name='背景图片')
