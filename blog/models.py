...
class Article(models.Model):
    ...
    """
    cover = models.URLField(max_length=200, default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/pexels-anna-nekrashevich-face.jpg',
                            verbose_name='文章封面')
...
class Link(models.Model):
    ...
    avatar = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/5a94e8dd6a694f646072c33755806288.jpg',
                             verbose_name='头像')
...
class Notice(models.Model):
    ...
    icon = models.CharField(default='far fa-lightbulb',
                            max_length=50,
                            verbose_name='公告图标')
...
class Site(models.Model):
    ...
    logo = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/quanyecha.jpg',
                           max_length=100,
                           verbose_name='网站logo')
    ...
    bg_cover = models.URLField(default='https://cdn.jsdelivr.net/gh/sunbcy/Bcy_picbed@main/pexels-katja-592077.jpg',
                               max_length=100,
                               verbose_name='背景图片')
